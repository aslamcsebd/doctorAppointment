...
class SslCommerzPaymentController extends Controller
{
    ...
    {          
        ...
        $post_data = array();
        $post_data['total_amount'] = $request->advance; # You cant not pay less than 10
        ...
        # OPTIONAL PARAMETERS
        $post_data['value_a'] = $bookingType;
        $post_data['value_b'] = $bookingId->id;
        $post_data['value_c'] = $post_data['tran_id'];
        $post_data['value_d'] = $request->totalRent;
    ...
    public function payViaAjax(Request $request)
    {
        ...
        $post_data = array();
        $post_data['total_amount'] = '112'; # You cant not pay less than 10
        $post_data['currency'] = "BDT";
        $post_data['tran_id'] = uniqid(); // tran_id must be unique

                ...
                <div class="card-body p-1">
                    <div class="card border border-danger">
                        <div class="card-body p-3">
                            <form action="{{ route('updateHospitalInfo') }}" method="post" enctype="multipart/form-data"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="name" name="name"
                                        value="{{ $hospitalInfo->name ?? 'Add hospital name' }}" autocomplete="off"
                                        class="form-control">
                                </div>
                                ...
                                <div class="row p-0 m-0 border">
                                    <div class="form-group col-2">
                                        <div class="px-4 pt-2">
                                            <img id="preview"
                                                src="{{ asset('') }}/{{ $hospitalInfo->photo ?? 'images/default.jpg' }}"
                                                alt="Company photo" class="avatar">
                                        </div>
                                    </div>
                                    <div class="form-group col-10 mt-3">
                                        ...
                                        <label for="photo" class="custom-file-label" style="width:99%;">Choose
                                            file</label>
